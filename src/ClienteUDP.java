...
public class ClienteUDP {
    ...
    public static void main(String[] args) throws UnknownHostException {
        String mensajito = JOptionPane.showInputDialog("Ingrese el mensaje que desea enviar:");
        try {
            DatagramSocket socket = new DatagramSocket();
            byte[] mensajeByte = mensajito.getBytes(); //Convierte el mensaje en una cadena de bytes.
            InetAddress host = InetAddress.getByName("127.0.0.1");
            int puerto = 9107;
            DatagramPacket paquete = new DatagramPacket(mensajeByte, mensajito.length(), host, puerto);
